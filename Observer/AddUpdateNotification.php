...
{
    private const PACKAGE     = 'etechflow/module-ai-seo';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-ai-seo.json';
    private const CACHE_KEY   = 'etechflow_aiseo_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_AiSeo';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow AI SEO %1 is available', $latest['version']);
