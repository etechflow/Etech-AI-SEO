...
class Checkout extends Action
{
    ...
    private const PLAN_SLUGS = ['aiseo_weekly', 'aiseo_monthly', 'aiseo_yearly'];
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('aiseo/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('aiseo/license/activated'),
            'magento_cancel'   => $this->getUrl('aiseo/license/gate'),
        ]);
